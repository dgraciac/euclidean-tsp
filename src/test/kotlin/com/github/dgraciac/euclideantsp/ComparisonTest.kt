...
/*        var bruteForceTour: Tour? = null
        measureTimeMillis { bruteForceTour = bruteForce.compute(instance) }.let {
            println("Algorithm: BruteForce; Instance name: ${instance.name}; Time: ${it / 1000.0}s; Length: ${bruteForceTour?.length}; Approximation: ${bruteForceTour?.length?.div(instance.optimalLength)}")
            println("==============================================")
        }*/
